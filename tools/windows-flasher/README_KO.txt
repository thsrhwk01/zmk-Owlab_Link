...
3. 안내가 나오면 키보드의 USB 케이블을 분리합니다.
4. PCB의 물리 B 버튼을 누른 채 USB를 연결한 다음 B 버튼에서 손을 뗍니다.
5. Flash complete가 표시되면 USB 케이블을 분리합니다.
6. B 버튼을 누르지 않은 상태로 USB를 다시 연결합니다.
7. 키보드가 Owlab Link로 연결되는지 확인합니다.
